...
def load_mesh_and_create_device(device_name, mesh_file):
    ...
    # **FIXED**: Added the required 'material="Ideal"' parameter to both contact definitions.
    devsim.add_gmsh_contact(mesh=device_name, gmsh_name="anode", region="p_region", name="anode", material="Ideal")
    devsim.add_gmsh_contact(mesh=device_name, gmsh_name="cathode", region="n_region", name="cathode", material="Ideal")
